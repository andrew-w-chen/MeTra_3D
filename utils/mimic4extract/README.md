...
=========================
## Note
The code and readme is taken from https://github.com/nyuad-cai/MedFuse/tree/main/mimic4extract but slightly adapted to fix a couple of bugs that occured during processing.
