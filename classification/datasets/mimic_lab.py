...
def load_cxr_ehr(cfg):
    ...
    print(f'{cfg.dataset.ehr_data_dir}/{cfg.dataset.task}/val_listfile.csv') #debugging
...
class MIMICCXR(Dataset):
    ...
    def __getitem__(self, index):
        if isinstance(index, str):
            ...
            #print(f"Path for index '{index}': {self.filenames_to_path.get(index, 'Key not found')}") #debugging
