...
class LightningClassifier(pl.LightningModule):
    ...
    def get_scheduler(self):
        ...
        if self.cfg.scheduler.lr_scheduler == "cosine_annealing_warm_restarts":
            scheduler = {'scheduler': torch.optim.lr_scheduler.CosineAnnealingWarmRestarts(
        ...
        if self.cfg.scheduler.lr_scheduler == "plateau":
            ...
            'monitor': 'Val_mean_auc',} # Define the metric to monitor
    ...
    def lr_scheduler_step(self, scheduler, optimizer_idx, metric=None):
        # Implement custom logic for stepping the scheduler
